...
- **배치 scalar regime: vpack로 재측정 → B≤16 win(Phase 35 정정).** GQA(32/8) B1 0.86× / B4 0.90× /
  B8 0.92× / B16 0.99–1.00× WIN, B32만 1.01–1.03× slight loss(거기서 MXINT8이 BW-bound 133 GB/s 도달,
  MSAQ는 dequant-throttle로 97=0.73×). Phase 35의 "배치 universal loss(1.07–1.26×)"는 vpack 이전 커널
  결과였음. (Phase 43)
