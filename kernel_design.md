...
| KV decode (MXINT8) | 3.00 ms | **~0.062 ms** | ~48× | memory-bound 근접 · MXINT8/SDPA ≈ 0.34× |
| GEMV (MSAQ) | 1.16 ms | **~0.30 ms** | ~3.8× | MSAQ/MXINT8 ≈ 5.9 |
| GEMV (MXINT8) | 0.64 ms | **~0.05 ms** | ~12× | **≈ cuBLAS** |
| **GEMM prefill MSAQ** (M=256, u4) | 46.6 ms | **1.91 ms** | ~24× | **MSAQ/MXINT8 = 0.90×** ✅ |
| **GEMM prefill MXINT8** (M=256, u4) | 6.2 ms | **2.12 ms** | ~3× | tiled, FP32 core |
